...
namespace Herjon\EmailAttachments\Model;
...
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder
{
    ...
    protected function prepareMessage()
    {
        ...
        $parts = count($this->parts) ? array_merge([$mimePart], $this->parts) : [$mimePart];
    ...
    public function addAttachment(
        ...
        $mimePart = $this->partFactory->create(['content' => $content]);
